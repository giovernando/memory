...
const Card: FC<iCardProps> = ({
	...
	return (
		<div className="h-screen flex items-center justify-center sticky top-0 md:p-0 px-4">
			<div
				className="relative flex flex-col h-[350px] w-[90vw] md:h-[550px] md:w-[1000px] py-12 px-10 md:px-12
				rotate-0 items-center justify-center mx-auto 
				shadow-md pr-3 pl-3 pt-3 pb-4 overflow-hidden rounded-xl md:rounded-2xl"
			...
			>
				...
				<div
					className="font-manrope text-lg md:text-2xl font-medium text-center mb-0 z-10 mt-4 lowercase tracking-wide max-w-2xl"
