...
export function GallerySection() {
  ...
  const images = [
    { src: "/images/foto21.jpeg", alt: "Modern architecture at sunrise" },
    { src: "/images/foto22.jpeg", alt: "Modern architecture in daylight" },
    { src: "/images/foto23.webp", alt: "Modern architecture at dusk" },
    { src: "/images/foto24.webp", alt: "Modern architecture at night" },
  ];
